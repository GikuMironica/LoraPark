...
import 'package:lorapark_app/data/controllers/weather_station_controller.dart';
...
class _WeatherStationPage extends State<WeatherStationPage> {
  ...
  Widget build(BuildContext context) {
    final WheatherStationController weatherStationController =
        Provider.of<WheatherStationController>(context);
    ...
    return Scaffold(
      body: Stack(children: <Widget>[
        ...
        RefreshIndicator(
          onRefresh: () => weatherStationController
              .getActualWeatherData(Sensors.weatherStation_one),
