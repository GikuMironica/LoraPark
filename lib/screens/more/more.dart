            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow( blurRadius: 3, spreadRadius: 3, color: Colors.black.withOpacity(0.15))]
                ),
                child: Column(
                  children: [
                    Padding(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('Our Partners', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                    Container(
                      child: Wrap(
